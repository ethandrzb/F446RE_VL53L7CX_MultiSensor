...
/** @addtogroup XNUCLEO_53L7A1
  * @{
  */

/** @addtogroup XNUCLEO_53L7A1_RANGING_SENSOR
  * @{
  */

/** @defgroup XNUCLEO_53L7A1_RANGING_SENSOR_Exported_Variables Exported Variables
  * @{
  */
void *VL53L7A1_RANGING_SENSOR_CompObj[RANGING_SENSOR_INSTANCES_NBR] = {0};
/**
  * @}
  */

/** @defgroup XNUCLEO_53L7A1_RANGING_SENSOR_Private_Variables Private Variables
  * @{
  */
static RANGING_SENSOR_Drv_t *VL53L7A1_RANGING_SENSOR_Drv = NULL;
static RANGING_SENSOR_Capabilities_t VL53L7A1_RANGING_SENSOR_Cap;
/**
  * @}
  */

/** @defgroup XNUCLEO_53L7A1_RANGING_SENSOR_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
int32_t VL53L7A1_RANGING_SENSOR_DeInit(uint32_t Instance)
{
  ...
  else if (VL53L7A1_RANGING_SENSOR_Drv->DeInit(VL53L7A1_RANGING_SENSOR_CompObj[Instance]) < 0)
  {
...
int32_t VL53L7A1_RANGING_SENSOR_SetAddress(uint32_t Instance, uint32_t Address)
{
  ...
  else if (VL53L7A1_RANGING_SENSOR_Drv->SetAddress(VL53L7A1_RANGING_SENSOR_CompObj[Instance], Address) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
